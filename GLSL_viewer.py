...
from OpenGL.GL import (
    glGetUniformLocation, glActiveTexture, glBindTexture, glClear, glUseProgram,
    glUniform1f, glUniform3fv, glUniform4f, glUniform1i, glBegin, glTexCoord2f,
    glVertex3f, glEnd, glClearColor, glGenTextures, glTexImage2D, glTexParameteri,
    GL_TEXTURE0, GL_TEXTURE_2D, GL_COLOR_BUFFER_BIT, GL_DEPTH_BUFFER_BIT,
    GL_TRIANGLES, GL_VERTEX_SHADER, GL_FRAGMENT_SHADER, GL_RGB, GL_UNSIGNED_BYTE,
